...
namespace AgentSalaries
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            TrafficAgent agente4 = new TrafficAgent(1, "agente-4", "position-02",
                new DateTime(2020, 06, 20),
            ...
            {
                Console.WriteLine("Agente: " + agent.Name + " Salario: $" +
